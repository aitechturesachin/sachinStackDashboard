...
//             <Bar dataKey="value" fill="#38bdf8" radius={[20, 20, 0, 0]} />
//           </BarChart>
//         </ResponsiveContainer>
//       </div>
...
const datasets = {
  ...
  Year: ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"].map(
    (m) => ({ label: m, value: Math.round(200000 + Math.random() * 250000) })
  ),
};
      ...
      <div className="bar-chart">
        <ResponsiveContainer width="100%" height={260}>
          <BarChart data={data} margin={{ top: 10, right: 10, bottom: 0, left: 0 }}>
            ...
            <XAxis dataKey="label" stroke={axis.stroke} tickLine={false} axisLine={{ stroke: axis.stroke }} />
            <YAxis stroke={axis.stroke} tickLine={false} axisLine={{ stroke: axis.stroke }} />
            <Tooltip
